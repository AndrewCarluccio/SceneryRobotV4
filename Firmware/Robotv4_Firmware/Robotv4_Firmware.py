...
while(True):
    ...
    if (words[0] == "forward"):
        ...
        roboclaw.SpeedAccelDeccelPositionM1(address,300,500,200,int(full_rotation / 4.0),1)
        roboclaw.SpeedAccelDeccelPositionM2(address,300,500,200,int(full_rotation / -4.0),1)
